...
public class RCP_Manager : Lvl_Manager
{
    public RGManager rg;
    ...
    IEnumerator Tareas(int tarea)
    {
        ...
        switch (tarea)
        {
            case 0://presentacion
                ...
                break;
            case 1://acercarse a la victima
                rg.aro.SetActive(true);
                ...
                //se completa en el aro
                break;
            case 2://pide agacharte
                while (audioController.audioSource.isPlaying == true)
                {
                    //Debug.Log("Se esta reproduciendo audio");
                    yield return new WaitForFixedUpdate();
                }
                //Se Completa al agacharse
                break;
            case 3://muestra panel
                rg.paneles[0].SetActive(true);
                //Tarea inicial, se ejecuta al iniciar el proyecto
                while (audioController.audioSource.isPlaying == true)
                {
                    //Debug.Log("Se esta reproduciendo audio");
            ...
            case 20://sele indica al usuario ponerse de pie
                ...
                break;
            case 21://audio de postura aprendida
                //GManagerErgo.ge.aros_ubic(8);
                //Tarea inicial, se ejecuta al iniciar el proyecto
                while (audioController.audioSource.isPlaying == true)
                {
                ...
                CumplirTarea(21);
                break;
            case 22://palabras de despedidas
                //GManagerErgo.ge.aros_ubic(8);
