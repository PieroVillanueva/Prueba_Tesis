...
public class VRFootIK : MonoBehaviour
{
    ...
    private void OnAnimatorIK(int layerIndex)
    {
        ...
        bool hasHit = Physics.Raycast(rightFootPos + Vector3.up, Vector3.down, out hit,10,maskGround);
        ...
        hasHit = Physics.Raycast(leftFootPos + Vector3.up, Vector3.down, out hit, 10, maskGround);        
